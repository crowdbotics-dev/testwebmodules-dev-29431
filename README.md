...
## Project Structure
    ...
    ├── testwebmodules_dev_29431  # Django project configurations
...
1. Clone this repo and `cd testwebmodules_dev_29431`
...
2. Clone this repo and `cd testwebmodules_dev_29431`
